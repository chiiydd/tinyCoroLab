...
> ⭐原先的付费文档已全部开源，您可尽情阅读作者精心编写的增值免费文档！！！

tinyCoroLab实验的进行需要搭配文档，你将体验到类似cmu15445的学习方式，即个人独立一步步完成所有实验，但作者额外新增了增值文档，即**实验+预备知识讲解+全套实验图文解析+完整面试实战+持续更新的番外知识**，通过学习该内容，您可收获：
...
开源项目及文档编写不易，能帮助到您便是我最大的动力，也希望您将该项目分享至更多人🌞！
